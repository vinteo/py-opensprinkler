...
SCHEDULE_TYPE_INTERVAL_DAY_CODE = 3
SCHEDULE_TYPE_MONTHLY = "monthly"
SCHEDULE_TYPE_MONTHLY_CODE = 2
SCHEDULE_TYPE_SINGLE_RUN = "single-run"
SCHEDULE_TYPE_SINGLE_RUN_CODE = 1
SCHEDULE_TYPE_WEEKLY = "weekday"
SCHEDULE_TYPE_WEEKLY_CODE = 0

SCHEDULE_START_TIME_FIXED = "fixed_time"
SCHEDULE_START_TIME_FIXED_CODE = 1
SCHEDULE_START_TIME_REPEATING = "repeating"
SCHEDULE_START_TIME_REPEATING_CODE = 0
